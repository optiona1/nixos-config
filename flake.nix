{
  ...
  inputs = {
    ...
    home-manager = {
      ...
      url = "https://gh-proxy.org/https://github.com/nix-community/home-manager/archive/release-25.11.tar.gz";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    noctalia = {
      url = "git+https://gh-proxy.org/https://github.com/noctalia-dev/noctalia-shell";
      # url = "github:noctalia-dev/noctalia-shell";
      inputs.nixpkgs.follows = "nixpkgs-unstable";
      inputs.noctalia-qs.follows = "noctalia-qs";
    };
    noctalia-qs = {
      url = "git+https://gh-proxy.org/https://github.com/noctalia-dev/noctalia-qs";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    nixvim = {
      url = "git+https://gh-proxy.org/https://github.com/nix-community/nixvim?ref=nixos-25.11";
      inputs.nixpkgs.follows = "nixpkgs";
    };
      ...
      nixosConfigurations = builtins.mapAttrs (hostName: hostModule:
        nixpkgs.lib.nixosSystem {
          ...
          modules = [
            ...
            {
              home-manager = {
                extraSpecialArgs = { inherit inputs username nixvim; };
